...
This is a web server that allows users to perform CRUD (Create, Read, Update, Delete) operations on a list of books stored in a MongoDB database. It was created as a test task for GoIT
